...
public class OnlineFrag extends Fragment {
    ...
    String enunit, enempid, enrole, enpagesize, enpagenumber, enkk, enkey, enmode, ensort;
    ...
    private static final String TAG_TITLE = "Doc_Title";
    ...
    private static final String TAG_PRIOR = "UrutanPrioritas";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.disposisi_frag, container, false);
        ...
        listView = (ListView) v.findViewById(R.id.lvDisposisi);
        String fragment = "online";
        suratAdapter = new SuratAdapter(getActivity(), suratList,fragment);
...
//Open a new activity when a list item is clicked.
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                pindah.putExtra("fragment","online");
                ...
                if ((lastInScreen == totalItemCount) && !(loadingMore)) {
                    if (listView.getLastVisiblePosition() >= count - threshold && count < totalRows) {
                        ...
                        if(isInternetPresent) {
                            ...
                            ambilDisOnline ambilDisOnline = new ambilDisOnline();
                            ambilDisOnline.execute(enmode, enunit, enempid, enrole, enpagesize, enpagenumber, enkk, enkey, ensort);
                        }else{
    ...
    public void ambilListOnline()
    {
        ...
        if(isInternetPresent) {
            ...
            try {
                enmode = krip.bytesToHex(krip.encrypt(mode));
    ...
    public void showAlertHapusFavorit(final int pos){
        getActivity().runOnUiThread(new Runnable() {
            public void run() {
                // TODO Auto-generated method stub
                AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
                builder.setMessage(Config.alertHapusFavorit).setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                ...
                builder.setMessage(message).setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (Kode.equals("1")) {
                            ...
                            /*if (suratList.get(pos).getDoccode().equals("U"))
                                suratList.get(pos).setIconFav(R.mipmap.ic_ur);
                            else if (suratList.get(pos).getDoccode().equals("D"))
                                suratList.get(pos).setIconSurat(R.mipmap.ic_dis);*/
    ...
    class ambilDisOnline extends AsyncTask<String, Void, JSONArray> {
        ...
        protected JSONArray doInBackground(String... params) {
            ...
            String pagenumber = params[5];
            String katakunci = params[6];
            String key = params[7];
            ...
            List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
            nameValuePairs.add(new BasicNameValuePair(Config.TAG_APIKEY, key));
            nameValuePairs.add(new BasicNameValuePair(Config.TAG_MODE, mode));
            ...
            try {
                HttpClient httpClient = new DefaultHttpClient();
                HttpPost httpPost = new HttpPost(Config.urlLanding + "GetListInboxDisposisiByMode.php");
                httpPost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
