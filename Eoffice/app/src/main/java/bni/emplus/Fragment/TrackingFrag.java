...
public class TrackingFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.tracking_frag, container, false);
        ...
        listView = (ListView) v.findViewById(R.id.lvTrack);
        String fragment = "tracking";
        suratAdapter = new SuratAdapter(getActivity(),suratList,fragment);
        listView.setAdapter(suratAdapter);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                pindah.putExtra("fragment","tracking");
                ...
                if ((lastInScreen == totalItemCount) && !(loadingMore)) {
                    if (listView.getLastVisiblePosition() >= count - threshold && count < totalRows) {
                        ...
                        if(isInternetPresent) {
                            ...
                            ambilTrack ambilTrack = new ambilTrack();
                            ambilTrack.execute(enunit, enempid, enrole, enpagesize, enpagenumber, enkk, enkey, ensort);
                        }else {
    ...
    class ambilTrack extends AsyncTask<String, Void, JSONArray> {
        ...
        protected JSONArray doInBackground(String... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost(Config.urlLanding + "GetListTrackingHistory.php");
