 ...
 */
public class HardcopyFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                pindah.putExtra("fragment","hardcopy");
                ...
                if ((lastInScreen == totalItemCount) && !(loadingMore)) {
                    if (listView.getLastVisiblePosition() >= count - threshold && count < totalRows) {
                        ...
                        if(isInternetPresent) {
                            ...
                            ambilDisHard ambilDisHard = new ambilDisHard();
                            ambilDisHard.execute(enmode, enunit, enempid, enrole, enpagesize, enpagenumber, enkk, enkey, ensort);
                        }else{
    ...
    class ambilDisHard extends AsyncTask<String, Void, JSONArray> {
            ...
            if (result != null) {
                for (int i = 0; i < result.length(); i++) {
                    try {
                        ...
                        String crtime = e.getString("CreatedTime");
